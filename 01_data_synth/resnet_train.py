...
label = sys.argv[1]
train_dataset = SpatialDataset(is_train=True,  outputs=outputs, parametrized=True, histogram=True, with_noise=False, rotate=False)
...
for i in range(1,max_epochs+1):
    ...
    best_wmape = val_step(model, i, val_loader, 'resnet_%s' % label, outputs, best_wmape)
